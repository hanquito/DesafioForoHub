package com.challengue.forohub.infra.errors;
...
class)
    public ResponseEntity<String> invalidBodyHandler(Exception e){
        return ResponseEntity.badRequest().body("Algunas partes del cuerpo de la solicitud estan expresadas incorrectamente");
    }
