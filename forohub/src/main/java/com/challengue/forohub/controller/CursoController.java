...
import com.challengue.forohub.domain.curso.dto.ActualizarCursoDTO;
import com.challengue.forohub.domain.curso.dto.CrearCursoDTO;
import com.challengue.forohub.domain.curso.dto.DetalleCursoDTO;
...
public class CursoController {
    ...
    public ResponseEntity<Page<DetalleCursoDTO>> ListarCurso(@PageableDefault(size = 10,sort={"nombre"}) Pageable pageable){
    ...
    public ResponseEntity<DetalleCursoDTO> ListarUnCurso(@RequestBody @Valid DetalleCursoDTO detalleCursoDTO, @PathVariable Long id){
    ...
    @PutMapping("/{id}")
    @Transactional
    @Operation(summary="Actualiza el nombre, la categoria o el estado de un curso")
