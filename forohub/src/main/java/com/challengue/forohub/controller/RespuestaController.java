...
import com.challengue.forohub.domain.respuesta.dto.CrearRespuestaDTO;
...
import com.challengue.forohub.domain.respuesta.validations.create.ValidarRespuestaCreada;
import com.challengue.forohub.domain.respuesta.validations.update.ValidaRespuestaActualizada;
...
@Tag(name="Respuesta", description = "Solo uno puede ser la solucion a el tema")
public class RespuestaController {
    ...
    @Autowired
    List<ValidaRespuestaActualizada> actualizarValidadores;
    ...
    public ResponseEntity<DetalleRespuestaDTO> actualizaRespuesta(@RequestBody @Valid ActualizarRespuestaDTO actualizarRespuestaDTO,@PathVariable Long id){
