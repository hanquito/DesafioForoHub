...
import com.challengue.forohub.domain.usuario.dto.AutenticacionUsuarioDTO;
import com.challengue.forohub.infra.security.dto.JWTtokenDTO;
import com.challengue.forohub.infra.service.TokenService;
...
@Tag(name = "Autenticacion", description ="Obtiene el token del usuario designado para el acceso.")
